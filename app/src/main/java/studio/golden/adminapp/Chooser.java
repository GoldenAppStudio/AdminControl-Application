...
public class Chooser extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public static String linkX;
    public static String province;
    public static String[] county;
    public static String key;
    public static String sub_service;
    final public static String[] district = new String[1];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.class_name5);
        mState = findViewById(R.id.state_spinner5);
        mDistrict = findViewById(R.id.district_chooser5);
        ssss = findViewById(R.id.ssss5);
        submit = findViewById(R.id.submitDetails5);
        bbbb = findViewById(R.id.bbbb5);
        textView = findViewById(R.id.textView);


        progressDialog = new ProgressDialog(Chooser.this, R.style.MyTheme);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Chooser.this, android.R.layout.simple_spinner_item, categories);
        ...
        submit.setOnClickListener(v -> {
            ...
            textView.setText("Choose Sub-Service");
            ...
            db.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Chooser.this, android.R.layout.simple_spinner_item, c);
                        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        bbbb.setOnClickListener(v -> {
            ...
            sub = ssss.getSelectedItem().toString();
                ...
                linkX  = "Service/"+service+"/"+sub+ "/"+state+"/"+ district[0] +"/";
                key = service; sub_service = sub; province = state; county = district;
                Intent intent = new Intent(Chooser.this, SPEdit.class);
